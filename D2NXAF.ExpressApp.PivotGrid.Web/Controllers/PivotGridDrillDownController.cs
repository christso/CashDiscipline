...
namespace D2NXAF.ExpressApp.PivotGrid.Web.Controllers
{
    public abstract class PivotGridDrillDownController : ViewController<ListView>, IXafCallbackHandler
    {
        ...
        public void ProcessAction(string parameter)
        {
            ...
            if (TargetDefaultValuesController != null)
            {
                ...
                var defaultValuesController = (D2NXAF.ExpressApp.Controllers.DefaultValuesViewController)Activator.CreateInstance(TargetDefaultValuesController, dicPivotFieldValues);
